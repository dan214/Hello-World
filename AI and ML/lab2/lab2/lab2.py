...
def bfs(graph, start, goal):
    ...
    newpath = [start]
    agenda[top] = newpath
    while agenda[top][-1] is not goal:          
        ...
        #we pop the element at the top of the list
        smma = agenda.pop(top)
        print 'element popped',smma
        print 'agenda after popping',agenda
        extendedpaths = []
        smallpath = []
        for i in connected_nodes:
            print 'agenda at the first line',agenda
            smma.append(i)
            print 'smma',smma
            agenda[top] = smma
            print 'agenda[top]',agenda[top]
            extendedpaths.append(smma)
            print agenda
            top = top + 1
            print 'top',top
##            smma.remove(i)

        print 'extendedpaths',extendedpaths
        for x in extendedpaths:
            agenda[top] = x
            top = top + 1
...
myPath = branch_and_bound(GRAPH1,'Stairs','Common Area')
print 'myPath',myPath

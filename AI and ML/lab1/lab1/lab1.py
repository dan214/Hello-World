...
# family_rules.
family_rules = [(IF ( AND ('parent (?x) (?y)','female (?y)'), THEN ('daughter (?y) (?x)'))),(IF ( AND ('parent (?x) (?y)','parent (?x) (?z)','male (?y)') ,THEN ('brother (?y) (?z)'))),(IF ( AND ('parent (?x) (?y)','parent (?x) (?z)','female (?y)') ,THEN ('sister (?y) (?z)'))),(IF ( AND ('parent (?x) (?y)','female (?x)') ,THEN ('mother (?x) (?y)'))),(IF ( AND ('parent (?x) (?y)','male (?x)') ,THEN ('father (?x) (?y)'))),(IF ( AND ('parent (?x) (?y)','male (?y)') ,THEN ('son (?y) (?x)'))),(IF ( AND ('parent (?x) (?y)','parent (?z) (?a)',OR('brother (?x) (?z)','sister(?x) (?z)')) ,THEN ('cousins (?y) (?a)'))),(IF ( AND ('parent (?x) (?y)','parent (?z) (?x)') ,THEN ('grandparent (?z) (?y)'))),(IF ( AND ('parent (?x) (?y)','parent (?z) (?x)') ,THEN ('grandchild (?y) (?z)')))]                    # fill me in

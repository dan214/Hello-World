...
class RectangularRoom(object):
    ...
    def getRandomPosition(self):
        ...
        """
        firstInt = random.randint(0,self.width)
        secondInt = random.randint(0,self.height)
        return Position(firstInt,secondInt)
...
class Robot(object):
    ...
    def updatePositionAndClean(self):
        ...
        xPos = Position.getX()
        yPos = Position.getY()
        RectangularRoom.cleanTileAtPosition(self.position)
        stepChoices = [(xPos + 1,yPos),(xPos,yPos + 1),(xPos - 1,yPos),(xPos,yPos - 1)]
        newX,newY = random.choice(stepChoices)
